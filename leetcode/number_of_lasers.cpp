...
int numberOfBeams(vector<string>& bank) {
  int n = 0, tmp = 0;
  for (auto s : bank) {
    int d = accumulate(s.begin(), s.end(), 0, [](int acc, char c) {return acc + (c - '0');});
    if (d == 0) continue;
    n += tmp * d;
    tmp = d;
  }
...
int main() {
    vector<string> bank1, bank2;
    bank1 = {"00000","00101","10100","11110","11100","01001","00100","11010"};
    bank2 = {"000","111","000"};

    cout << numberOfBeams(bank1) << endl;
    cout << numberOfBeams(bank2) << endl;
    return 0;
}
