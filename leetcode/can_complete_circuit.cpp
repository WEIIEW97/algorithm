...
int main() {
  ...
  cout.tie(nullptr);
  // Your code here
  vector<int> g1, g2, c1, c2;
  g1 = parse_vector("[1,2,3,4,5]");
  c1 = parse_vector("[3,4,5,1,2]");
  g2 = parse_vector("[2,3,4]");
  c2 = parse_vector("[3,4,3]");

  print_res(canCompleteCircuit, g1, c1);
  print_res(canCompleteCircuit, g2, c2);
