...
int main() {
  ...
  grid1 = parse_matrix("[[2,5,4],[1,5,1]]");
  grid2 = parse_matrix("[[3,3,1],[8,5,2]]");
  grid3 = parse_matrix("[[1,3,1,15],[1,3,3,1]]");

  print_res(gridGame, grid1);
  print_res(gridGame, grid2);
  print_res(gridGame, grid3);
