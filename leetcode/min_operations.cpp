...
one ball from the second box to the third box in one operation. Example 2:
...
int main() {
  print_res(minOperations, "110");
  print_res(minOperations, "001011");
